...
public class BurnCommand extends BaseCommand {
    ...
    public BurnCommand() {
        super("burn", "Podpala gracza na określoną liczbę sekund", "/burn <gracz> <sekundy>", "tfbhc.cmd.burn", new String[]{"podpal"});
    }

    @Override
    public boolean execute(CommandSender sender, String[] args) {

        // Komenda wymaga dokładnie 2 argumentów
        if (args.length != 2) {
        ...
        // 3. Sprawdzenie, czy nie podpalamy admina z bypass
        ...
        // 4. Aplikacja podpalenia
        // 1 sekunda = 20 ticków.
        int ticks = seconds * 20;

        // Jeśli gracz jest już podpalony, ten kod wydłuży czas podpalenia.
    ...
    public List<String> tabComplete(CommandSender sender, String[] args) {
        ...
        if (args.length == 2) {
            // Podpowiadanie przykładowych czasów
